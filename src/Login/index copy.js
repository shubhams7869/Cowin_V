...
export default class Login extends React.Component {
    ...
    checkState(){
        if(this.getCookie("token")===""&&(this.state.msg!=="Send OTP" && this.state.msg!=="Confirm OTP")){
            this.setState({
                msg: "Send OTP"
            });
        }
    ...
    async getBeneficiaries() {
        ...
        let token = this.state.token ? this.state.token : "";
    ...
    myLogin ()  {
        ...
        if (this.state.msg === "Send OTP") {
            ...
            return <div>
                <input type='text' id='login' placeholder="Enter Mobile" value={this.state.mobile} />
                <button onClick={this.loginHandler}>{this.state.msg}</button>
            </div>
        }
        else if (this.state.msg === "Confirm OTP") {
            return <div>
                <input type='text' id='login' placeholder="Enter OTP" />
                <button onClick={this.loginHandler}>{this.state.msg}</button>
            </div>
        }
            ...
            return <Beneficiaries benList={this.state.benList}/>
        }
